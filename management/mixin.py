...
from management.models import BaseRequestLog
            ...
            self.log.update(
                {
                    ...
                    'response':  base64.b64encode(response.rendered_content) if hasattr(response, 'rendered_content') else  base64.b64encode(response.getvalue()),
...
class APIRequestLog(BaseRequestLog):
    pass
